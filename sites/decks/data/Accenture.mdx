...
import { Stats, BigIcon, Cover, SectionCover, Basic, Feature, Icons, Quote, Agenda } from "../src/slides"
...
Links are constantly shared but hardly ever read, let alone processed and
stored, resulting in a knowledge gap in your organization.
