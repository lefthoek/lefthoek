...
Principles such as 'pay it forward' are crucial to a healthy coworking
environment, but people are not inclined to do it by nature. The game maker
continuously sets challenges and rewards to encourage people to share knowledge
...
In time, circles of people tend to stabilize. The cocktail shaker periodically
connects people within the network with one another based on interest,
personality, and a healthy degree of randomness. On top of that, it also creates
the in which the encounter can take place.  
[Broaden Circles]   
...
occassionally occur. The tie breaker resolves these resulting conflicts on the
basis of transparent rules, open procedures, and healthy feedback loops to
prevent technocratic decisions.
[Fortify Values]    
[Coach, Referee]
